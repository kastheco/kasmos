...
|---------|--------------|---------------|
| no trigger is processed | missing `KASMOS_LINEAR_API_KEY` or `LINEAR_API_KEY`, or the daemon is not running | confirm the systemd unit environment and daemon status. |
