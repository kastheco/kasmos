...
linear receipts post compact, deterministic comments from kasmos to explicitly linked Linear issues. kasmos remains the execution source of truth: Linear can display progress, but it cannot transition kasmos tasks.
