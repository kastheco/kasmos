...
```json
{"signal_type": "verify_approved", "plan_file": "<plan>", "project": "<project>", "payload": "{\"reviewed_sha\":\"<full-head-sha>\"}"}
```
or with the CLI:
```bash
