...
- `sidebar` fits the complete monitor into a persistent, narrow host pane.

non-apps-sdk hosts should implement the versioned [monitor host contract](./monitor-host-contract.mdx).
