...
- **new contributor?** Start with [development setup](./development-setup.mdx) to get the project building locally.
- **writing a fix or feature?** Read [testing](./testing.mdx) to understand how the test suite is structured and what CI checks.
- **unfamiliar with the codebase?** The [architecture overview](./architecture-overview.mdx) maps out the key directories and explains how the major subsystems connect.
