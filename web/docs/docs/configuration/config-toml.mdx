...
`permission_default` can be set per profile to `"inherit"`, `"prompt"`, or `"bypass"`; see [agent profiles: permission_default](./agent-profiles.mdx#permission_default) for resolution details.
