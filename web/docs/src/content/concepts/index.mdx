...
See [plans and tasks](/concepts/plans-and-tasks) for the full document format.
...
See [waves](/concepts/waves) for elaboration, blueprint-skip, and state transitions.
...
See [topics](/concepts/topics) for the exact collision logic.
...
See [agents and roles](/concepts/agents-and-roles) for profile fields and execution modes.
...
See [lifecycle](/concepts/lifecycle) for all statuses, events, and valid transitions.
...
See [worktrees](/concepts/worktrees) for checkout, resume, and orphan adoption.
