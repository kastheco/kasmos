...
kasmos maps lifecycle phases to role names in `kasmos.toml` under `[phases]`. When you run `kas setup`, the wizard writes defaults based on which harnesses you select:
