...
- **new contributor?** Start with [development setup](/contributing/development-setup) to get the project building locally.
- **writing a fix or feature?** Read [testing](/contributing/testing) to understand how the test suite is structured and what CI checks.
- **unfamiliar with the codebase?** The [architecture overview](/contributing/architecture-overview) maps out the key directories and explains how the major subsystems connect.
