...
- [service management](./systemd-services) — run `kas serve` as a persistent user service (systemd or launchd)
- [configuration](/configuration) — full `config.toml` reference
- [cli reference](/cli-reference) — `kas serve` flags
