...
- [lifecycle](/concepts/lifecycle) — full FSM transition table
- [agents and roles](/concepts/agents-and-roles) — reviewer and fixer profiles
- [cli reference: kas task](/cli-reference/task) — task subcommands
