...
- [waves](/concepts/waves) — how wave orchestration works internally
- [worktrees](/concepts/worktrees) — how each task gets an isolated git branch
- [agents and roles](/concepts/agents-and-roles) — architect, coder, and solo agent profiles
