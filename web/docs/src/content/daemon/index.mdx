...
- [architecture](/daemon/architecture) — core types and the event loop in detail
- [setup](/daemon/setup) — launchd/systemd user services and Just recipes
- [signals](/daemon/signals) — filesystem and DB-backed signal paths
- [multi-repo](/daemon/multi-repo) — repo registration rules
- [pr monitor](/daemon/pr-monitor) — automated PR review handling
