...
See [plans and tasks](./plans-and-tasks.mdx) for the full document format.
...
See [waves](./waves.mdx) for elaboration, blueprint-skip, and state transitions.
...
See [topics](./topics.mdx) for the exact collision logic.
...
See [agents and roles](./agents-and-roles.mdx) for profile fields and execution modes.
...
See [lifecycle](./lifecycle.mdx) for all statuses, events, and valid transitions.
...
See [worktrees](./worktrees.mdx) for checkout, resume, and orphan adoption.
