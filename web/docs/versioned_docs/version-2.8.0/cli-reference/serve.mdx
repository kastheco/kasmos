...
| method | path | description |
|--------|------|-------------|
| `GET` | `/v1/projects/{project}/tasks/{filename}/architect-decisions` | return the cached architect `decision_audit`, final task markdown, and optional architect baseline markdown for hq task details |
