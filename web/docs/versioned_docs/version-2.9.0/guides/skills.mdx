...
- [agent harnesses](./agent-harnesses.mdx) — how harness dirs are structured and how skills are loaded
- [kas check](../cli-reference/index.mdx) — audit command reference
- [kas skills sync](../cli-reference/index.mdx) — sync command reference
