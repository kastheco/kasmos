...
Reports skill sync status across all detected harnesses at both the global (`~/.agents/skills/`) and project (`.agents/skills/`) layers. See [skills](./skills.mdx) for details.
