...
This command merges a completed feature branch into the master/target branch and handles cleanup of worktrees and branches.
...
- Branch: Should show your feature branch name like `001-feature-name` (NOT `master` or `release/*`)
...
Before merging research to master, perform final validation:
