...
Research WPs produce deliverables in a **worktree**, which merge to master like code.
...
| **Planning Artifacts** | `kitty-specs/{{feature_slug}}/research/` (in master) | SECONDARY - Citation validation only |
