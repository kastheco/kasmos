...
// PaneRunner abstracts external command execution for CapturePane.
...
// ErrSessionGone is returned by CapturePane when tmux reports that the target
// session, window, or pane no longer exists.
