...
type TmuxCLI interface {
	...
	ShowOption(ctx context.Context, key string) (string, error)
...
func (t *tmuxExec) ShowOption(ctx context.Context, key string) (string, error) {
	return t.run(ctx, "show-option", "-v", key)
}
