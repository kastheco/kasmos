...
- Keep `/spec-kitty.clarify` on the controller agent (heavy tier) for ambiguity reduction quality.
- Do not delegate high-impact clarification decisions to light-tier agents.
