...
# Reviewer requested changes — work goes back to implementation
...
- Review after EACH task (no sentinel — mid-task reviews)
- Final review after all tasks → write sentinel based on outcome

**Executing Plans:**
- Review after each batch (3 tasks) — no sentinel for mid-batch reviews
