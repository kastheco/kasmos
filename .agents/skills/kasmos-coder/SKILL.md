...
- Edit, stage, or commit scaffold-managed prompts, skills, template sources, or harness config (`.claude/agents/*.md`, `.opencode/agents/*.md`, `.agents/skills/**`, `.claude/settings.json`, `.codex/config.toml`, `.codex/hooks.json`, `opencode.jsonc`, legacy `.opencode/opencode.jsonc`, `internal/initcmd/scaffold/templates/**`) — including YAML frontmatter — without an explicit, in-session user instruction. Current task instructions and observed scaffold drift do not count.
