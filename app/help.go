...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		descStyle.Render("sdk sessions are not attachable; use the preview pane, compact info header, logs, and prompt overlay while they run."),
		"",
...
func (h helpTypeInstanceStart) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		descStyle.Render("interactive attach is only available for tmux sessions; sdk sessions use the preview pane and audit log."),
		"",
