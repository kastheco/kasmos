...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("K")+descStyle.Render("         - Kill (delete) the selected session"),
		...
		keyStyle.Render("i")+descStyle.Render("         - Interactive mode: type in pane (ctrl+space to exit)"),
