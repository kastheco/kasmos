...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("tab/shift+tab")+descStyle.Render(" - cycle panes (sidebar → list → agent → diff → git)"),
		...
		keyStyle.Render("g")+descStyle.Render("             - open lazygit (ctrl+space to exit)"),
		...
		keyStyle.Render("N")+descStyle.Render("             - new session with prompt"),
		keyStyle.Render("S")+descStyle.Render("             - new session (skip permissions)"),
		keyStyle.Render("↵/o")+descStyle.Render("           - attach to selected session"),
		...
		keyStyle.Render("p")+descStyle.Render("             - new plan"),
