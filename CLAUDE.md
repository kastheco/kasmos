...
| `config/` | Configuration management (project-local TOML config, one-time legacy JSON migration, agent profiles) |
...
| `.agents/` | Shared project skills mirrored into harness-specific directories |
