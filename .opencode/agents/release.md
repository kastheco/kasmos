...
kasmos monitors worker status automatically via its tmux backend. You do not need to send messages to any external pane. Track progress via `spec-kitty` commands.
