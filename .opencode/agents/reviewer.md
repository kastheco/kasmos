...
kasmos monitors worker status automatically via its tmux backend. You do not need to send messages to any external pane. Record your verdict via `spec-kitty agent tasks move-task` commands.
