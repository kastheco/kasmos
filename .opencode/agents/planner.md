...
kasmos monitors worker status automatically via its tmux backend. You do not need to send messages to any external pane. Focus on planning artifacts and spec-kitty commands.
